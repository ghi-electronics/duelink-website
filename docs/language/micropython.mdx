...
We'll use [Thonny](https://thonny.org/) IDE to program the RaspberryPi Pico in MicroPython. We will use the Pico to access DUELink modules attached to the [DuePico's](../products/adduepico-b) Downlink connector.
