...
To connect DUELink modules, you need a adaptor that adds a JST connector to micro:bit. See [micro:bit](../hw/microbit) for options, including [LinkBit](../catalog/adaptor/linkbit). 
