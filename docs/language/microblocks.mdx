...
To connect DUELink modules, you need an accessory that adds a JST connector to micro:bit. See [micro:bit](../hw/microbit) for options, including [LinkBit](../catalog/accessory/linkbit). 
