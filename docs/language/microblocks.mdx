...
:::tip
The console has 2 firmware options, you need the MicroBlocks option!
:::
...
:::tip
Another option is to ue the `Erase All` top-menu option that can be used to erase the device and put in DFU mode. No need to push any buttons on the device!
:::
