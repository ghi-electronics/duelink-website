...
Most of these boards don't have the required pull-up resistors on the I2C bus. This might not be a problem in most cases, but we have a [PullUp](../catalog/adaptor/pullup) module to solve this if there's an issue. When using our [LinkBit](../catalog/adaptor/linkbit) adaptor a PullUp module isn't needed.
