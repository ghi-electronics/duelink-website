...
Most of these boards don't have the required pull-up resistors on the I2C bus. This might not be a problem in most cases, but we have a [PullUp](../products/adpullup-a) module to solve this if there's an issue. When using our [LinkBit](../products/adlinkbit-a) adapter a PullUp module isn't needed.
...
Another great block-coding option is [MicroBlocks](./microblocks). It is fully supported, allowing micro:bit to connect to DUELink modules.
