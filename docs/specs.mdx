...
Every single module can still access USB by wiring a USB connector to the Uplink connector. We also offer [USB Hook](catalog/accessory/usb-hook) for convenience.
...
The DUELink [Sticker](catalog/accessory/sticker) is a mini development board that uses the [Stick](catalog/microcomputer/stick) to help you get started.
