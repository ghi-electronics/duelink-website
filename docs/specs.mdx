...
Every single module can still access USB by wiring a USB connector to the Uplink connector. We also offer [USB Hook](catalog/adaptor/usb-hook) for convenience.
...
The 5mm grid placement of holes aids in 3D-print and laser-cut enclosures design. It also allowed us to make [Holey Boards](catalog/adaptor/holey-board)!

![Holeyboard with Modules](pathname:///img/holeyboard-modules.png)

DUELink Accessories include [Mounting Hardware](catalog/adaptor/mount-hw) options.
...
The DUELink [Sticker](catalog/adaptor/sticker) is a mini development board that uses the [Stick](catalog/microcomputer/stick) to help you get started.
