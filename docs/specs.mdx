...
The 5mm grid placement of holes aids in 3D-print and laser-cut enclosures design. It also allowed us to make [Holey Boards](./products/axholeyboards-a)!

![Holeyboard with Modules](pathname:///img/holeyboard-modules.png)

DUELink Accessories include [Mounting Hardware](./products/axmounting-a) options.
...
Specialty boards are "special"! They can be of any shape and any color. The [Holiday Tree](./products/spholidaytree-b) is Green for example.
