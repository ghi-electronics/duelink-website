...
In some rare case, a module might have both Uplink and USB connector, like we have on [Ghizzy](/docs/products/ghizzy). In this case, the user can use either USB or Uplink as they are both wired together internally.
...
Specialty boards are "special"! They can be of any shape and any color. The [Holiday Tree](/docs/products/holiday-tree) is Green for example.
