...
The virtual serial interface is used to communicate with the [engine](../engine/intro). This works just like all other interfaces.
...
USB presents itself as a virtual USB-Serial port. Linux requires permissions to allow access to these ports. Further notes and example script are on the [UART](./uart) interface page.
