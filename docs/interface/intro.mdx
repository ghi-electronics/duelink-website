...
Every single DUELink module work with [USB](./usb), [I2C](./i2c), and [UART](./uart) on their Uplink connector. This socket is marked with `U` and is off-white color.

![Accel Module](pathname:///img/catalog/accel-front.png)
