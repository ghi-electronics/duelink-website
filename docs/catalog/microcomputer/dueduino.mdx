...
<table><td>
<Zoom><img alt="Front" src="/img/catalog/dueduino-front.png"/></Zoom>
</td><td>
<Zoom><img alt="Back" src="/img/catalog/dueduino-back.png"/></Zoom>
</td></table><p>
...
| --- | --- | ---
DUElink mainboard in an Arduino form factor | GDL-MBDUEDUINO-A | $00.00