...
<table><td>
<Zoom><img alt="Front" src="/img/catalog/octobit-front.png"/></Zoom>
</td><td>
<Zoom><img alt="Back" src="/img/catalog/octobit-back.png"/></Zoom>
</td></table><p>
**micro:bit inspired educational board with 8x8 LED matrix**
</p>
---
</div>
...
micro:bit inspired mainboard with 8x8 LED matrix
