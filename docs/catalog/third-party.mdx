...
Many other accessories are also useful, such as [USB Wedge](./accessory/usb-wedge), [USB Hook](./accessory/usb-hook), and [Breakout](./accessory/breakout)
...
There isn't much you need to do on the software front. Maybe a simple [Driver](../engine/drivers). You are welcome to [Download](../downloads) and use the DUELink firmware hex files on your own creations, free of charge, for commercial and non-commercial use!
