...
<td width='50%'>
 ...
 <tr>
<td width='50%'>
    <img alt="Size" src="/img/catalog/sppiano-a-3.webp" />
...
<td width='50%'>
    <img alt="Back" src="/img/catalog/mcdueduino-a-3.webp" />
    DueDuino is made for Arduino fans, with plenty of headers to experiment wth your favorite circuits.
    <Button
        style={{ margin: "10px", color: "white" }}
        label="Product Page"
