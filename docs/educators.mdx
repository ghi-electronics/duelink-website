...
:::tip
These eductor-focused boards ship preloaded with MicroBlocks. Users can always load, and reload, any DUELink module with any of the available software options.
:::
...
Educational-focused board have these in common:
