...
need a standard [Connector](./catalog/accessory/connector) to start [wiring](./catalog/accessory/cable) modules. We even have a [Breakout](./catalog/adapter/breakout) for easier wiring. You have the option to use one of the [Interfaces](./interface/intro), including [USB](./interface/usb), [I2C](./interface/i2c), and [Serial UART](./interface/uart)
</details>
