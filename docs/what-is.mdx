...
DUELink works with other [I2C](./interface/i2c) module ecosystems, including SparkFun Qwiic and Adafruit STEMMA. Want to go further? [Build your own](./catalog/third-party) modules using DUELink's [Stick](./catalog/microcomputer/stick) or [Stamp](./catalog/microcomputer/stamp) microcomputer to expand your toolkit.
...
need a standard [Connector](./catalog/adapter/connector) to start [wiring](./catalog/adapter/cable) modules. We even have a [Breakout](./catalog/adapter/breakout) for easier wiring. You have the option to use one of the [Interfaces](./interface/intro), including [USB](./interface/usb), [I2C](./interface/i2c), and [Serial UART](./interface/uart)
</details>
...
A universal rule is the [specification](./specs) of 5mm-pitched-holes. This allows for universal mounting, like with the available [Holey boards](./catalog/adapter/holey-board).

We even give you some [mounting hardware](./catalog/adapter/mount-hw) options! This rule helps when designing 3D packages or when building laser-cut enclosures.
</details>
