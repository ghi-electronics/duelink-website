...
If you enjoy the edge connector and alligator clips, DUELink offers many bit-compatible boards, such as the ultra-low-cost [CincoBit](../catalog/microconputer/cincobit) and also [PixoBit](../catalog/microconputer/pixobit) that includes a display.

  ![micro:bit](/img/cincobit-pixobit.png)   

The DUELink [CincoBit](../catalog/microconputer/cincobit) and [PixoBit](../catalog/microconputer/pixobit) work like all other DUELink modules, through DUELink [Scripting Engine](../engine/scripting) or the [Arduino](arduino) IDE, among other [Hosted Language](../language/intro) options. These microconputers can be used with micro:bit accessories, like in this robot!
