...
One of the two JST sockets becomes a [Downstream](../interface/downstream) bringing you hundreds of DUELink module options, that connect in a [Daisylink](../engine/daisylink).
