...
Wi-Fi or Bluetooth can also be used instead of USB. In fact, the PC libraries do not care what medium is being using. It sees a virtual serial port in any of these cases. [Wireless Hook](../catalog/accessory/wireless-hook) is an excellent module for this use.
