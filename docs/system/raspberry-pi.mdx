...
We recommend using DuePi Hat. The hat uses [UART](../interface/uart) and works with both full-size Raspberry Pi and Raspberry Pi Zero. It includes a display, buzzer, terminal block for wiring, and a [Downstream](../interface/downstream) socket to extend your RPI with hundreds of sensors and actuators.
