...
Use the [Breakout](../catalog/accessory/breakout) module to wire [UART Interface](../interface/uart) or [I2C Interface](../interface/i2c)from any BeagleBoard. When using I2C, pull-up resistors are required. The DUELink [PullUp](../catalog/accessory/pullup) module is available if needed.
