...
To connect micro:bit to one of the many DUElink modules, you can use the [LinkBit](../catalog/adaptor/linkbit) module. It extends the micro:bit edge connector and adds a [Downlink](../interface/downlink) connector.
...
Most of these third-party boards don't have the required pull-up resistors on the I2C bus. This might not be a problem in most cases, but we have a [PullUp](../catalog/adaptor/pullup) module to solve this if there's an issue. When using our [LinkBit](../catalog/adaptor/linkbit) adaptor a PullUp module isn't needed.
...
The DUELink [CincoBit](../catalog/microcomputer/cincobit) and [PixoBit](../catalog/microcomputer/pixobit) work like all other DUELink modules, through DUELink [Scripting Engine](../engine/scripting) or the [Arduino](arduino) IDE.
