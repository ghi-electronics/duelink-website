...
Most of these third-party boards don't have the required pull-up resistors on the I2C bus. This might not be a problem in most cases, but we have a [PullUp](../catalog/adapter/pullup) module to solve this if there's an issue. When using our [LinkBit](../catalog/adapter/linkbit) adapter a PullUp module isn't needed.
