...
All DUELink modules support the [USB Interface](./interface/usb). However, a few boards have a USB connector built but most will have an Uplink connector allowing for USB/I2C/UART interfaces. [USB Hook](./products/adusbhook-a) can be used to bring out the USB connection.
