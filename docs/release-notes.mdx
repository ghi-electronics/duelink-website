...
- Fixed Graphics add one extra one pixel when draw line, fill (rect).
- Implement i2c no data 255 protocal.
- Fixed DUELink switch to UART instead of I2C when connect to Microbit.
- Known Issues:
  - None.
...
-  Make "light level" block work on all DUE educational boards: CincoBit, PixoBit, ClipIt, and DueSTEM.
- Known Issues:
  - Large programs cause system lockup.
