...
USB Host Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/cmusbhost-b.pdf)<br/>
🔩[3D STEP file](/static/3d/CMUSBHOST-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the USB Host Rev B.
