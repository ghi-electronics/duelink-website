...
PixoBit Rev D - High-quality DUELink module
...
📄[Schematics](/static/sch/mcpixobit-d.pdf)<br/>
🔩[3D STEP file](/static/3d/MCPIXOBIT-D.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the PixoBit Rev D.
