...
Holiday Tree Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/spholidaytree-b.pdf)<br/>
🔩[3D STEP file](/static/3d/SPHOLIDAYTREE-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the Holiday Tree Rev B.
...
- **Part Number:** GDL-SPHOLIDAYTREE-B
- **Category:** Special
