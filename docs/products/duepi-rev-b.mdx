...
DuePi Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/adduepi-b.pdf)<br/>
🔩[3D STEP file](/static/3d/ADDUEPI-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the DuePi Rev B.
