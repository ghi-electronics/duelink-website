...
MotoMax Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/acmotomax-b.pdf)<br/>
🔩[3D STEP file](/static/3d/ACMOTOMAX-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the MotoMax Rev B.
