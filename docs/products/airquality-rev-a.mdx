...
AirQuality Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/seairquality-a.pdf)<br/>
🔩[3D STEP file](/static/3d/SEAIRQUALITY-A.step)<br/>
...
```python
# Example code for AirQuality Rev A
...
Coming soon! Check back for sample projects and tutorials using the AirQuality Rev A.
...
- **Part Number:** GDL-SEAIRQUALITY-A
- **Category:** Sensor
