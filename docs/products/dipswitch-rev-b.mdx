...
DipSwitch Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/hidipswitch-b.pdf)<br/>
🔩[3D STEP file](/static/3d/HIDIPSWITCH-B.step)<br/>
...
```python
# Example code for DipSwitch Rev B
...
Coming soon! Check back for sample projects and tutorials using the DipSwitch Rev B.
