...
Serial USB Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/cmserialusb-a.pdf)<br/>
🔩[3D STEP file](/static/3d/CMSERIALUSB-A.step)<br/>
...
```python
# Example code for Serial USB Rev A
...
Coming soon! Check back for sample projects and tutorials using the Serial USB Rev A.
