...
RTC Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/sertc-b.pdf)<br/>
🔩[3D STEP file](/static/3d/SERTC-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the RTC Rev B.
