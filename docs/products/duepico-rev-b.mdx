...
<ProductImageSelector 
  partNumber="adduepico-b"
  productName="DuePico Rev B"
/>
...
📄[Schematics](/sch/adduepico-b.pdf)<br/>
🔩[3D STEP file](/3d/adduepico-b.step)<br/>
...
```py reference title="DuePico Rev B Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/adapter/duepico.due
```
...
**GDL-ADDUEPICO-B** - DuePico Rev B - High-quality DUELink module - **$19.99**
