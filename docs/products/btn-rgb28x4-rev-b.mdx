...
BTN RGB28x4 Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/hibtnrgb28x4-b.pdf)<br/>
🔩[3D STEP file](/static/3d/HIBTNRGB28X4-B.step)<br/>
...
```python
# Example code for BTN RGB28x4 Rev B
...
Coming soon! Check back for sample projects and tutorials using the BTN RGB28x4 Rev B.
...
- **Part Number:** GDL-HIBTNRGB28X4-B
- **Category:** HMI
