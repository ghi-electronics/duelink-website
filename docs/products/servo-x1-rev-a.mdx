---
sidebar_position: 31
title: Servo X1 Rev A
description: Servo X1 Rev A - High-quality DUELink module
---
...
<ProductImageSelector 
  partNumber="acservox1-a"
  productName="Servo X1 Rev A"
/>

Servo X1 Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/acservox1-a.pdf)<br/>
🔩[3D STEP file](/static/3d/ACSERVOX1-A.step)<br/>
...
```python
# Example code for Servo X1 Rev A
...
Coming soon! Check back for sample projects and tutorials using the Servo X1 Rev A.
