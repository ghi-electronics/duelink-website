---
sidebar_position: 1
title: LED MT1208 Rev A
description: LED MT1208 Rev A - High-quality DUELink module
---
...
<ProductImageSelector 
  partNumber="lledmt1208r-a"
  productName="LED MT1208 Rev A"
/>
...
📄[Schematics](/sch/lledmt1208r-a.pdf)<br/>
🔩[3D STEP file](/3d/lledmt1208r-a.step)<br/>
...
```py reference title="LED MT1208 Rev A Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/led/led-mt1208.due
```
...
**GDL-LLEDMT1208R-A** - LED MT1208 Rev A - High-quality DUELink module - **$19.99**
