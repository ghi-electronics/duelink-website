...
<ProductImageSelector 
  partNumber="hibuttonl-a"
  productName="Button L Rev A"
/>
...
📄[Schematics](/sch/hibuttonl-a.pdf)<br/>
🔩[3D STEP file](/3d/hibuttonl-a.step)<br/>
...
```py reference title="Button L Rev A Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/hmi/button-l.due
```
...
**GDL-HIBUTTONL-A** - Button L Rev A - High-quality DUELink module - **$19.99**
