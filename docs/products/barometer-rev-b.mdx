...
Barometer Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/sebarometer-b.pdf)<br/>
🔩[3D STEP file](/static/3d/SEBAROMETER-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the Barometer Rev B.
