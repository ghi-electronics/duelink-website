...
```py reference title="Stamp Rev A Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/microcomputer/stamp.due
```
...
**GDL-MCSTAMP-A** - Stamp Rev A - High-quality DUELink module - **$19.99**
