...
sidebar_position: 50
title: Fingerprint
description: Fingerprint - High-quality DUELink module
...
📄<a href="/sch/gdl-hifingerprint-b.pdf" download>Schematics</a><br/>
🔩<a href="/3d/gdl-hifingerprint-b.step" download>3D STEP file</a><br/>
</td></table>
...
fn DetectBrd() # this for incase default setup from manufacture is 57600 then it set device to 9600 automatically
    SerCfg(9600, 1024)
    ...
    if r!=0 
        PrintLn("Switch to 9600: ", ", r = ", r)
        #switch to default 57600
        SerCfg(57600, 1024)
        
        # Send cmd for 9600
        TransRecPkg([0x0E, 0x4, 1],0) # #0x0E FINGERPRINT_WRITE_REG,  0x4:FINGERPRINT_BAUD_REG_ADDR 1: 9600
        
        #Wait 1 second for new baudrate applied            
        Wait(1000)
        
        # From now fingerprint is 9600, even after reset so next time b = 1, no need to switch back 57600 again
        reset(0)
