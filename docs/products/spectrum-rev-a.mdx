...
Spectrum Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/sospectrum-a.pdf)<br/>
🔩[3D STEP file](/static/3d/SOSPECTRUM-A.step)<br/>
...
```python
# Example code for Spectrum Rev A
...
Coming soon! Check back for sample projects and tutorials using the Spectrum Rev A.
