...
Thermal Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/vithermal-a.pdf)<br/>
🔩[3D STEP file](/static/3d/VITHERMAL-A.step)<br/>
...
```python
# Example code for Thermal Rev A
...
Coming soon! Check back for sample projects and tutorials using the Thermal Rev A.
