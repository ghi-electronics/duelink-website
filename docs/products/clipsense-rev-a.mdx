...
<ProductImageSelector 
  partNumber="seclipsense-a"
  productName="ClipSense Rev A"
/>

ClipSense Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/seclipsense-a.pdf)<br/>
🔩[3D STEP file](/static/3d/SECLIPSENSE-A.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the ClipSense Rev A.
