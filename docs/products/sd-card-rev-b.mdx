...
SD Card Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/stsdcard-b.pdf)<br/>
🔩[3D STEP file](/static/3d/STSDCARD-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the SD Card Rev B.
