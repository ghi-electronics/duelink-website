...
DMX Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/cmdmx-b.pdf)<br/>
🔩[3D STEP file](/static/3d/CMDMX-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the DMX Rev B.
