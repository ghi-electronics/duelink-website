...
<ProductImageSelector 
  partNumber="hibuttons-a"
  productName="Button S Rev A"
/>
...
📄[Schematics](/sch/hibuttons-a.pdf)<br/>
🔩[3D STEP file](/3d/hibuttons-a.step)<br/>
...
```py reference title="Button S Rev A Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/hmi/button-s.due
```
...
**GDL-HIBUTTONS-A** - Button S Rev A - High-quality DUELink module - **$19.99**
