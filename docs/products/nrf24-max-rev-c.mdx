...
NRF24 Max Rev C - High-quality DUELink module
...
📄[Schematics](/static/sch/wnrf24max-c.pdf)<br/>
🔩[3D STEP file](/static/3d/WNRF24MAX-C.step)<br/>
...
```python
# Example code for NRF24 Max Rev C
...
Coming soon! Check back for sample projects and tutorials using the NRF24 Max Rev C.
