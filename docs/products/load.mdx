...
📄<a href="/sch/gdl-acload-a.pdf" download>Schematics</a><br/>
🔩<a href="/3d/gdl-acload-a.step" download>3D STEP file</a><br/>
</td></table>
...
:::tip
No need for a driver! Use standard library DWrite() or PWrite() to activate any of the connections
:::
