...
<ProductImageSelector 
  partNumber="addueclick-a"
  productName="DueClick Rev A"
/>

DueClick Rev A - High-quality DUELink module
...
📄[Schematics](/static/sch/addueclick-a.pdf)<br/>
🔩[3D STEP file](/static/3d/ADDUECLICK-A.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the DueClick Rev A.
