...
CAN Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/cmcan-b.pdf)<br/>
🔩[3D STEP file](/static/3d/CMCAN-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the CAN Rev B.
