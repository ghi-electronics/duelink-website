...
TempHmd Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/setemphmd-b.pdf)<br/>
🔩[3D STEP file](/static/3d/SETEMPHMD-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the TempHmd Rev B.
