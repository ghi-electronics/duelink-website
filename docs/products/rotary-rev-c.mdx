...
Rotary Rev C - High-quality DUELink module
...
📄[Schematics](/static/sch/hikeypad4x4-c.pdf)<br/>
🔩[3D STEP file](/static/3d/HIKEYPAD4X4-C.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the Rotary Rev C.
