...
<ProductImageSelector 
  partNumber="hikeypad4x4-c"
  productName="Rotary Rev C"
/>
...
📄[Schematics](/sch/hikeypad4x4-c.pdf)<br/>
🔩[3D STEP file](/3d/hikeypad4x4-c.step)<br/>
...
```py reference title="Rotary Rev C Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/drivers/hmi/rotary.due
```
...
**GDL-HIKEYPAD4X4-C** - Rotary Rev C - High-quality DUELink module - **$19.99**
