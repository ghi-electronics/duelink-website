---
sidebar_position: 62
title: NRF24 Min Rev C
description: NRF24 Min Rev C - High-quality DUELink module
---
...
<ProductImageSelector 
  partNumber="wnrf24min-c"
  productName="NRF24 Min Rev C"
/>

NRF24 Min Rev C - High-quality DUELink module
...
📄[Schematics](/static/sch/wnrf24min-c.pdf)<br/>
🔩[3D STEP file](/static/3d/WNRF24MIN-C.step)<br/>
...
```python
# Example code for NRF24 Min Rev C
...
Coming soon! Check back for sample projects and tutorials using the NRF24 Min Rev C.
