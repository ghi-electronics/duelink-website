...
<ProductImageSelector 
  partNumber="acstepdrivep3-b"
  productName="StepDrive P3 Rev B"
/>

StepDrive P3 Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/acstepdrivep3-b.pdf)<br/>
🔩[3D STEP file](/static/3d/ACSTEPDRIVEP3-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the StepDrive P3 Rev B.
...
- **Part Number:** GDL-ACSTEPDRIVEP3-B
- **Category:** Actuator
