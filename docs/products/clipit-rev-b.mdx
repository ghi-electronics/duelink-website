...
ClipIt Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/mcclipit-b.pdf)<br/>
🔩[3D STEP file](/static/3d/MCCLIPIT-B.step)<br/>
...
Coming soon! Check back for sample projects and tutorials using the ClipIt Rev B.
