...
TempRTD Rev B - High-quality DUELink module
...
📄[Schematics](/static/sch/setemprtd-a.pdf)<br/>
🔩[3D STEP file](/static/3d/SETEMPRTD-A.step)<br/>
...
```python
# Example code for TempRTD Rev B
...
Coming soon! Check back for sample projects and tutorials using the TempRTD Rev B.
