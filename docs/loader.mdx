...
:::tip
While the provided online loader automatically handles Cloning, we are adding more details here for advanced uses. 
:::
...
The cloning feature can be used to update the firmware on modules that do not have a USB connection, and without using USB Hook. In this example, PixoBit can be loaded with the latest firmware and then it can be cloned to the chained modules.
