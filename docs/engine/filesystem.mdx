...
Use  [USB Host](../products/cmusbhost-b) to accessing files on USB thumb drives. It works just like SD cards but select type 2 media. The second and third arguments are ignored in USB host mode.
