...
All DUELink modules share teh same pin mapping and any additional pin features and restrictions. Pin GPIO numbers are mapped to be easier to use and are not one-to-one with what underlying micro has. 
