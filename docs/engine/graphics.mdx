...
In this case, we are using SSD1306. This display is found on [PixoBit](../catalog/microconputer/pixobit) microconputer and [OLED 096](../catalog/display/oled-096) display.
...
This is a perfect match for [CincoBit](../catalog/microconputer/cincobit) with its 5x5 LED matrix.
