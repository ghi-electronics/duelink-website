...
This example uses a 320x240 display, like [TFT CP23](../products/dtftcp23-b) in buffered mode with x3 multiplier.
...
In this case, we are using SSD1306. This display is found on [PixoBit](../products/mcpixobit-d) microcomputer and [OLED 096](../products/doled096-a) display.
...
These displays retain the graphics even after losing power. They are great for badges, labels and other zero-power usage. A good example is [ePaper M29](../products/depaperm29-a).
...
![ePaper M29](pathname:///img/catalog/depaperm29-a-1.png)

```py reference title="ePaper M29 Driver"
https://github.com/ghi-electronics/duelink-website/blob/dev/static/code/driver/gdl-depaperm29-a.txt
```