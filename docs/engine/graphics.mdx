...
Show()
```
This example below creates the same sprite using colors set to different elements of the sprite , note the use of `Alias()` to make the code more readable, and change the colors of sections easier.  
