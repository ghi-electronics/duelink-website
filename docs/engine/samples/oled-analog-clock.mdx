...
![OLED Analog Clock](img/oled-analog-clock.gif)


This example demonstrates using arrays of the DUELink [Scripting](../scripting) language. 
- Using arrays to store X,Y coordinates
- Using variable as both arrays and numbers
