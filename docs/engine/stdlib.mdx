...
- PWM capable pins: P0, P1, P2, P3, P4, P5, P6, P7, P8, P11.

PWM pins share internal timers. Changing the frequency on one will affect the other. Changing duty-cycle is okay however! For example, using a servo motor on P1 and a buzzer on P2 will cause problems as both share the same timer.
