...
By default, the device will not echo back what you enter. You can either enable echo from the device using `Echo(1)` command or by using local eco feature in the terminal software. 
