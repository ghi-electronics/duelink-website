...
```
Download and install the latest `GHIElectronics.DUELink` library from NuGet.org. Alternatively, 
get it from the [downloads](../downloads.mdx) page.
...
The [API](../api/intro.mdx) page includes all details and examples to use all the available "physical world" services.
