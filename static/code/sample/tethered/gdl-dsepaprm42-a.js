...
await DrawCircle(1, 100, 75, 56);
await DrawCircle(1, 100, 75, 57);
await DrawCircle(1, 100, 75, 63);
await DrawCircle(1, 100, 75, 64);
...
await DrawCircle(1, 100, 75, 58);
await DrawCircle(1, 100, 75, 59);
await DrawCircle(1, 100, 75, 60);
await DrawCircle(1, 100, 75, 61);
await DrawCircle(1, 100, 75, 62);
await Show();
